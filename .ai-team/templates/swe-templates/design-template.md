...
| 2 | [架构设计](#2-架构设计) | 系统架构、模块划分、技术选型 |
| 3 | [详细设计](#3-详细设计) | 模块详细设计、接口设计 |
| 4 | [数据库设计](#4-数据库设计) | 数据表、数据字典、迁移策略 |
| 5 | [前端设计](#5-前端设计) | 页面结构、组件设计、状态管理 |
| 6 | [后端设计](#6-后端设计) | 分层架构、API设计、服务设计 |
| 7 | [测试设计](#7-测试设计) | 测试策略、测试用例、性能测试 |
| 8 | [安全设计](#8-安全设计) | 认证、授权、数据安全 |
| 9 | [运维设计](#9-运维设计) | 监控、日志、部署、备份 |
| 10 | [完整性自检清单](#10-完整性自检清单) | 设计完整性检查 |
| 11 | [附录](#11-附录) | 术语表、参考文档等 |
| 12 | [使用说明](#12-使用说明) | 模板使用规则 |
