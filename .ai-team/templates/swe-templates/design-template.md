...
- [2. 架构设计](#2-架构设计)
  ...
  - [2.5 安全架构](#25-安全架构)
- [3. 详细设计](#3-详细设计)
  - [3.1 模块详细设计](#31-模块详细设计)
  - [3.2 接口设计](#32-接口设计)
- [4. 数据库设计](#4-数据库设计)
  - [4.1 数据库选型](#41-数据库选型)
  - [4.2 数据表设计](#42-数据表设计)
  - [4.3 数据字典](#43-数据字典)
  - [4.4 数据迁移策略](#44-数据迁移策略)
- [5. 前端设计](#5-前端设计)
  - [5.1 页面结构](#51-页面结构)
  - [5.2 组件设计](#52-组件设计)
  - [5.3 状态管理](#53-状态管理)
...
- [6. 后端设计](#6-后端设计)
  ...
  - [6.3 服务设计](#63-服务设计)
  - [6.4 缓存设计](#64-缓存设计)
  - [6.5 消息队列设计](#65-消息队列设计)
- [7. 测试设计](#7-测试设计)
  - [7.1 测试策略](#71-测试策略)
  - [7.2 测试用例设计](#72-测试用例设计)
  - [7.3 性能测试场景](#73-性能测试场景)
- [8. 安全设计](#8-安全设计)
  - [8.1 认证设计](#81-认证设计)
  - [8.2 授权设计](#82-授权设计)
  - [8.3 数据安全](#83-数据安全)
...
- [9. 运维设计](#9-运维设计)
  ...
  - [9.3 部署设计](#93-部署设计)
  - [9.4 备份设计](#94-备份设计)
- [10. 完整性自检清单](#10-完整性自检清单)
  - [10.1 架构设计完整性](#101-架构设计完整性)
  - [10.2 详细设计完整性](#102-详细设计完整性)
  - [10.3 设计一致性检查](#103-设计一致性检查)
  - [10.4 设计质量检查](#104-设计质量检查)
- [11. 附录](#11-附录)
  - [11.1 术语表](#111-术语表)
  - [11.2 参考文档](#112-参考文档)
  - [11.3 变更记录](#113-变更记录)
- [12. 使用说明](#12-使用说明)
  - [12.1 模板使用规则](#121-模板使用规则)
  - [12.2 AI自动化开发适配](#122-ai自动化开发适配)
  - [12.3 与其他文档的关系](#123-与其他文档的关系)
